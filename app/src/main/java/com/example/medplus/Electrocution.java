...
public class Electrocution extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.selectimg :
                i = new Intent(this,ElectrocutionImg.class);
                startActivity(i);
                break;

            case R.id.selectsteps :
                i = new Intent(this,ElectrocutionSteps.class);
                startActivity(i);
                break;
        }
